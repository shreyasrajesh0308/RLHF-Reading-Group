...
| 2 | Feb 19 | Ch 4-5 | Instruction tuning + Reward models | Train ORM: `uv run python -m reward_models.train_orm --samples 400` | TBD |
| 3 | Feb 26 | Ch 5 cont | Process reward models | Train PRM, discuss ORM vs PRM tradeoffs | TBD |
| 4 | Mar 5 | Ch 6 | Policy gradients (REINFORCE, RLOO) | Implement REINFORCE loss by hand, run RLOO | TBD |
| 5 | Mar 12 | Ch 6 cont | PPO, GRPO | Run PPO vs GRPO, discuss clipping and variance | TBD |
